...
onnx_path = 'models/ultra_light/ultra_light_models/version-RFB-640.onnx'
...
fa = face_utils.facealigner.FaceAligner(shape_predictor, desiredFaceWidth=112, desiredLeftEye=(0.35, 0.35))
...
#     with tf.Session() as sess:
        ...
        # saver = tf.train.import_meta_graph('models/mfn/vgg/model-vgg.meta')
        # saver.restore(sess, 'models/mfn/vgg/model-vgg.ckpt-275')
